...
Service-Modul für Mail-Jobs innerhalb der Srv-Jobarchitektur.
...
Danach steht `Srv_Mail` zur Verfügung.

## Typisches Beispiel

```php
// Beispiel für Srv_Mail
// Klasse nach Include der _config.inc.php direkt nutzbar.
```

## Öffentliche Methoden

_Keine öffentlichen Methoden gefunden oder reine Platzhalterklasse._
