# Time
## Zweck
`Time` kapselt Zeit- und Datumshelfer für konsistente Ausgabe und Berechnung.
## Datei und Einbindung
- Klasse: `Time`
- Datei: `assets/php/inc/gbdb_framework/core/time.php`
...
|---|---:|---|
| `timeAgo(mixed $timestamp)` | `string` | Gibt wieder, wie lange ein Datum her ist (deutsche Ausgabe) |
