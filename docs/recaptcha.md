...
Google-reCAPTCHA-Validierung für Formulare.
...
Danach steht `ReCaptcha` zur Verfügung.
...
|---|---|---|
|`postName()`|string|öffentliche Methode der Klasse|
|`checkBox(string $callbackJs = "")`|string|öffentliche Methode der Klasse|
|`verify(?string $token)`|bool|öffentliche Methode der Klasse|
|`loadJsApi()`|void|öffentliche Methode der Klasse|
