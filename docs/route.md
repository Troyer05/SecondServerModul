...
Routing- und Pfadhelfer für einfache Seitensteuerung.
...
Danach steht `Route` zur Verfügung.
...
|---|---|---|
|`middleware(callable $mw)`|self|öffentliche Methode der Klasse|
|`get(string $path, callable $callback)`|void|öffentliche Methode der Klasse|
|`post(string $path, callable $callback)`|void|öffentliche Methode der Klasse|
|`put(string $path, callable $callback)`|void|öffentliche Methode der Klasse|
|`delete(string $path, callable $callback)`|void|öffentliche Methode der Klasse|
|`patch(string $path, callable $callback)`|void|öffentliche Methode der Klasse|
|`notFound(callable $callback)`|void|öffentliche Methode der Klasse|
|`methodNotAllowed(callable $callback)`|void|öffentliche Methode der Klasse|
|`dispatch()`|void|öffentliche Methode der Klasse|

## Interne Hilfsmethoden

|Hilfsmethode|Sichtbarkeit|
|---|---|
|`addRoute(string $method, string $path, callable $callback)`|private|
|`makePattern(string $path)`|private|
