...
MuseumQR API-Client/Wrapper für externe MuseumQR-Funktionen.
...
Danach steht `MqrApi` zur Verfügung.
...
|---|---|---|
|`getFeedback(string $item_id = "")`|array|öffentliche Methode der Klasse|
|`getObjects()`|array|öffentliche Methode der Klasse|
|`getObject(string $oid)`|array|öffentliche Methode der Klasse|
|`getSettings()`|array|öffentliche Methode der Klasse|
|`getLangs()`|array|öffentliche Methode der Klasse|
|`getTours()`|array|öffentliche Methode der Klasse|
|`newApiKey(string $permission = "readwrite")`|array|öffentliche Methode der Klasse|
|`saveSettings(string $theme, string $name, string $intro)`|array|öffentliche Methode der Klasse|
|`newLang(string $lid, string $name)`|array|öffentliche Methode der Klasse|
|`newTour(string $name)`|array|öffentliche Methode der Klasse|
