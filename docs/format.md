...
Formatierungshelper für Datum, Zeit, Strings und Zeilenumbrüche.
...
Danach steht `Format` zur Verfügung.
...
|---|---|---|
|`dateForInput(mixed $date)`|string|öffentliche Methode der Klasse|
|`timeForInput(mixed $time)`|string|öffentliche Methode der Klasse|
|`dateToView(mixed $date)`|string|öffentliche Methode der Klasse|
|`shortString(string $string, int $maxLength = 14)`|string|öffentliche Methode der Klasse|
|`cleanString(string $string)`|string|öffentliche Methode der Klasse|
|`newLineCode(string $string, bool $forHtml = true)`|string|öffentliche Methode der Klasse|

## Interne Hilfsmethoden

|Hilfsmethode|Sichtbarkeit|
|---|---|
|`validDate(mixed $value)`|private|
