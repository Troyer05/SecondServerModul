...
Referenz-/Redirect-/URL-Helfer des Frameworks.
...
Danach steht `Ref` zur Verfügung.
...
|---|---|---|
|`to(string $url)`|void|öffentliche Methode der Klasse|
|`this_file()`|void|öffentliche Methode der Klasse|
