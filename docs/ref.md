# Ref
## Zweck
`Ref` dient als kleine Referenz-/Hilfsklasse für wiederkehrende Ausgaben und interne Abkürzungen.
## Datei und Einbindung
- Klasse: `Ref`
- Datei: `assets/php/inc/gbdb_framework/core/ref.php`
...
|---|---:|---|
| `to(string $url)` | `void` | Leitet auf eine andere Datei/Seite weiter |
| `this_file()` | `void` | Ladet aktuelle Seite neu |
