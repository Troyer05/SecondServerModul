    ...
    public static function updateUser(int $id, array $data): bool {
        ...
        return (bool)self::inSystem(function () use ($id, $data) {
            ...
            if (isset($data["username"])) {
                ...
                $exists = !$sameName && GBDBv2::elementExists(self::SYSTEM_DB, self::USERS_TABLE, "username", $username);
            ...
            $ok = GBDBv2::editData(self::SYSTEM_DB, self::USERS_TABLE, "id", $id, $set);

            if ($ok && (int)(self::user()["id"] ?? 0) === $id) {
                $fresh = GBDBv2::getData(self::SYSTEM_DB, self::USERS_TABLE, true, "id", $id);
