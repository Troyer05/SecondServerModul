...
Proprietär / greenbucket®
Du entscheidest – ich setze dir gerne eine MIT/Apache Lizenz auf Wunsch.

---

# 🙌 Support

Wenn du Erweiterungen willst:

🔥 SQL-Sync
🔥 Type-Schemas (z.B. BOOL, INT, ENUM)
🔥 UI 2.0 (Tailwind / AlpineJS)
🔥 Multi-User-System
🔥 Zugriffspolicies (ACL)
🔥 API-Mode mit Token-Auth
...
### ✔ README für greenql_ui  
### ✔ Entwicklerhandbuch (Docs)  
### ✔ API-Dokumentation  
### ✔ Architekturdiagramm  
### ✔ Flowcharts für GBDB  
...
👉 **"Mach mir die Developer Docs"**  
oder  
👉 **"Mach mir die API-Doku"**
