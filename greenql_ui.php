...
if (!Vars::__DEV__()) { echo 'Seite gesperrt!'; exit; } 

include DEV_INC . "/greenql.php";
?>
                ...
                <div class="db-tree">
                    ...
                    <?php foreach ($snapshot['dbs'] as $db) { ?>
                        ...
                        <div class="db-node <?php echo $activeDb ? 'is-active' : ''; ?>">
                            <a class="db-link" href="?db=<?php echo urlencode($db); ?>">
                            ...
                            <?php if ($activeDb) { ?>
                                <div class="table-list">
                                    ...
                                    <?php foreach ($dbTables as $table) { ?>
                                        <a class="table-link <?php echo $table === $currentTable ? 'is-active' : ''; ?>" href="?db=<?php echo urlencode($db); ?>&t=<?php echo urlencode($table); ?>">
            ...
            <section class="content-grid data-grid">
                <div class="panel preview-panel">
                    <div class="panel-head">
                        ...
                        <?php if ($currentTable !== '') { ?>
                            <a class="secondary-btn link-btn" href="?db=<?php echo urlencode($currentDb); ?>&t=<?php echo urlencode($currentTable); ?>">Aktualisieren</a>
                        <?php } ?>
                    </div>
