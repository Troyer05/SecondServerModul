...
<body>
  <div id="main">
    ...
    <div id="middle">
      <div id="left-column">
        <h3 style="color: #555;">Info</h3>
        <p>
          Willkommen bei GreenQL UI!<br><br>
          Hier k&ouml;nnen Sie die Datenbank
          Struktur der GBDB verwalten.
          Achten Sie darauf, Vars::__DEV__()
          auf false zu setzen, damit diese Ansicht im Produktiven System nicht erreichbar ist.
        </p>
        <!-- <ul class="nav">
